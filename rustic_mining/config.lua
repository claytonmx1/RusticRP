Config = {
    ...
    ChanceToGetItem = 1, -- if math.random(0, 100) <= ChanceToGetItem then give item
    Items = {
    	'stone'
    },
    ...
    StoneWashPositions = {
        {coords = vector3(1933.12, 430.6, 162.05), heading = 256.04}
    },
}

Strings = {
    ['press_mine'] = 'Press ~INPUT_CONTEXT~ to mine stone.',
    ['press_wash'] = 'Press ~INPUT_CONTEXT~ to wash stone.',
